...
class Comportamento(models.Model):
    nome = models.CharField(max_length=200, default='padrao', unique=True)

# Tipo é o constituinte de um ataque ou o material do qual um monstro é feito, talvez seja bom mudar para enum
class Tipo(models.Model):
    nome = models.CharField(max_length=200, default='carne', unique=True)


class Ataque(models.Model):
    nome = models.CharField(max_length=200, unique=True) #talvez possa ser removido
...
class Carta(models.Model):
    ...
    attack = models.ForeignKey(Ataque, on_delete=models.CASCADE, null=True) #dar o mesmo nome é ruim !!!
